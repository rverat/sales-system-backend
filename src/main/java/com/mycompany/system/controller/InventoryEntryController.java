...
@Autowired
    ...
    public ResponseEntity<List<InventoryEntryResponse>> getAll() {
        
        return new ResponseEntity<>(service.getAll(), HttpStatus.OK);
    }

    @PostMapping
    public ResponseEntity<HttpStatus> create(@RequestBody InventoryEntry systemEntry) {
                
	service.save(systemEntry);
        return new ResponseEntity<>(HttpStatus.CREATED);
    }

    @PatchMapping
    public ResponseEntity<HttpStatus> update(@RequestBody InventoryEntry systemEntry) {
                
	service.update(systemEntry);
