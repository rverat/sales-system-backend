...
public class ProductCategoryController {
    ...
    public ResponseEntity<List<ProductCategory>> getAll(@RequestHeader(HttpHeaders.AUTHORIZATION) String token) throws ParseException, JOSEException {
    ...
    @PostMapping
    public ResponseEntity<HttpStatus> create(@RequestHeader(HttpHeaders.AUTHORIZATION) String token, @RequestBody ProductCategory productCategory) throws ParseException, JOSEException {
    ...
    @PatchMapping
    public ResponseEntity<HttpStatus> update(@RequestHeader(HttpHeaders.AUTHORIZATION) String token, @RequestBody ProductCategory productCategory) throws ParseException, JOSEException {
