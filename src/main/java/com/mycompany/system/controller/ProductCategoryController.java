...
public class ProductCategoryController {
    ...
    @PostMapping
    public ResponseEntity<HttpStatus> create(@RequestBody ProductCategory productCategory) {
    ...
    @PatchMapping
    public ResponseEntity<HttpStatus> update(@RequestBody ProductCategory productCategory) {
