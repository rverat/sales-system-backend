 ...
 * @author ro
 */
public class InventoryOutput extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        lblProductId = new javax.swing.JTextField();
        ...
        jPanel2.add(cboStore, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 20, 250, -1));

        lblId.setEditable(false);
        jPanel2.add(lblId, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 20, 190, -1));

        btnAddStore.setText("Nueva Sucursal");
        btnAddStore.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAddStoreActionPerformed(evt);
            }
        });
        jPanel2.add(btnAddStore, new org.netbeans.lib.awtextra.AbsoluteConstraints(741, 20, 150, -1));

        jLabel8.setText("Cantidad:");
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, 70, -1));
        jPanel2.add(spnAmoun, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 100, 130, -1));

        lblProductId.setEditable(false);
        jPanel2.add(lblProductId, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 60, 190, -1));
    ...
    private javax.swing.JTextField lblProductId;
